...
# example:
# .\database-rebuild-all.ps1 sql-travels sqlserver docker dbo ..\AppWebApi
# .\database-rebuild-all.ps1 sql-travels sqlserver docker dbo ..\AppRazor
# .\database-rebuild-all.ps1 sql-travels sqlserver docker dbo ..\AppMvc
