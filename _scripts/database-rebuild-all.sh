...
# example:
# ./database-rebuild-all.sh sql-travels sqlserver docker dbo ../AppWebApi
# ./database-rebuild-all.sh sql-travels sqlserver docker dbo ../AppRazor
# ./database-rebuild-all.sh sql-travels sqlserver docker dbo ../AppMvc
